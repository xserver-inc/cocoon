 ...
 *
 * @description Container for language type used to describe the language value associated with the item.
 * @implements \ArrayAccess<string, mixed>
 */
class LanguageType implements ModelInterface, ArrayAccess, \JsonSerializable
{
