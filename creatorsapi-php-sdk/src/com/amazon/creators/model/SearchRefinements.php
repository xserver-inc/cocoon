 ...
 *
 * @description Container for SearchRefinements resource which helps in filtering search results obtained from SearchItems operation. It contains relevant SearchIndexes, BrowseNodes and other dynamic refinements for a search request.
 * @implements \ArrayAccess<string, mixed>
 */
class SearchRefinements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchRefinements';
    ...
    protected static $openAPITypes = [
        'browseNode' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\Refinement',
        'otherRefinements' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\Refinement[]',
        'searchIndex' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\Refinement'
    ];
    ...
    {
        $this->setIfExists('browseNode', $data ?? [], null);
        $this->setIfExists('otherRefinements', $data ?? [], null);
    ...
    */
     ...
     * Sets browseNode
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\Refinement|null $browseNode browseNode
     *
     * @return self
     */
     ...
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\Refinement[]|null $otherRefinements List of refinements.
     *
     * @return self
     */
    public function setOtherRefinements($otherRefinements)
    {
        if (is_null($otherRefinements)) {
            throw new \InvalidArgumentException('non-nullable otherRefinements cannot be null');
        }
     ...
     * Sets searchIndex
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\Refinement|null $searchIndex searchIndex
     *
     * @return self
     */
