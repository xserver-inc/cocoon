 ...
 *
 * @description Container for set of attributes that tell what age group is suitable to view said media.
 * @implements \ArrayAccess<string, mixed>
 */
class ContentRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentRating';
    ...
    protected static $openAPITypes = [
        'audienceRating' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\SingleStringValuedAttribute'
    ];
    ...
    {
        $this->setIfExists('audienceRating', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets audienceRating
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\SingleStringValuedAttribute|null $audienceRating audienceRating
     *
     * @return self
     */
