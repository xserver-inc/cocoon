 ...
 *
 * @description Used to return the information about the Money value or amount. Consists of the integral value, the currency codes and the formatted price which can be used for display purposes.
...
class Money implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('displayAmount', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets displayAmount
     *
     * @param string|null $displayAmount displayAmount
     *
     * @return self
     */
    public function setDisplayAmount($displayAmount)
    {
        if (is_null($displayAmount)) {
            throw new \InvalidArgumentException('non-nullable displayAmount cannot be null');
        }
