 ...
 *
 * @description The container for Items response. It consists of resultant Items for the GetItems request.
 * @implements \ArrayAccess<string, mixed>
 */
class ItemsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemsResult';
