 ...
 *
 * @description Container for customer reviews information associated with a product. Includes weighted star rating and total reviews count.
 * @implements \ArrayAccess<string, mixed>
 */
class CustomerReviews implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerReviews';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('starRating', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets starRating
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\Rating|null $starRating starRating
     *
     * @return self
     */
