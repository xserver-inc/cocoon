 ...
 *
 * @description Container for BrowseNode Child information which contains BrowseNodeId, DisplayName and ContextFreeName information associated with the BrowseNode Child.
 * @implements \ArrayAccess<string, mixed>
 */
class BrowseNodeChild implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrowseNodeChild';
