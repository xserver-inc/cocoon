 ...
 *
 * @description Container for a refinement bin which contains values for a particular refinement.
 * @implements \ArrayAccess<string, mixed>
 */
class RefinementBin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefinementBin';
