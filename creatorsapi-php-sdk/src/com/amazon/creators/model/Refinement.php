 ...
 *
 * @description Container for a search refinement which includes refinement attributes like Id, Display Name and refinement values.
...
class Refinement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'bins' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\RefinementBin[]',
        'displayName' => 'string',
        'id' => 'string'
    ];
    ...
    */
     ...
     * Gets bins
     *
     * @return \Amazon\CreatorsAPI\v1\com\amazon\creators\model\RefinementBin[]|null
     */
     ...
     * Sets bins
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\RefinementBin[]|null $bins List of refinement bins which contains the values for a particular refinement.
     *
     * @return self
     */
