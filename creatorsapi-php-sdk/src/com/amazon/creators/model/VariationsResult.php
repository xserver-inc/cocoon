 ...
 *
 * @description The container for Variations response. It consists of items and variation summary. Items contains the list of product variations with their attributes (e.g., different colors, sizes). VariationSummary provides metadata about the complete set of variations including pagination info, price range, and the dimensions along which products vary.
 * @implements \ArrayAccess<string, mixed>
 */
class VariationsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariationsResult';
    ...
    protected static $openAPITypes = [
        ...
        'variationSummary' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\VariationSummary'
    ];
    ...
    protected static $setters = [
        'items' => 'setItems',
        'variationSummary' => 'setVariationSummary'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('variationSummary', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\VariationSummary|null $variationSummary variationSummary
     *
     * @return self
     */
    public function setVariationSummary($variationSummary)
    {
        if (is_null($variationSummary)) {
            throw new \InvalidArgumentException('non-nullable variationSummary cannot be null');
        }
        $this->container['variationSummary'] = $variationSummary;
