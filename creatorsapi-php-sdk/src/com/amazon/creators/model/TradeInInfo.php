 ...
 *
 * @description Container for set of attributes that specifies trade-in information of the product.
 * @implements \ArrayAccess<string, mixed>
 */
class TradeInInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradeInInfo';
    ...
    protected static $openAPITypes = [
        ...
        'price' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\TradeInPrice'
    ];
    ...
    {
        $this->setIfExists('isEligibleForTradeIn', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $isEligibleForTradeIn isEligibleForTradeIn
     *
     * @return self
     */
    public function setIsEligibleForTradeIn($isEligibleForTradeIn)
    {
        if (is_null($isEligibleForTradeIn)) {
            throw new \InvalidArgumentException('non-nullable isEligibleForTradeIn cannot be null');
        }
     ...
     * Sets price
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\TradeInPrice|null $price price
     *
     * @return self
     */
