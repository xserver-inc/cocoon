...
/**
 * OfferConditionV2 Class Doc Comment
 *
 * @description Specifies the condition of the offer.
 * @implements \ArrayAccess<string, mixed>
 */
class OfferConditionV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferConditionV2';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('conditionNote', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets subCondition
     *
     * @param string|null $subCondition subCondition
     *
     * @return self
     */
     ...
     * Sets conditionNote
     *
     * @param string|null $conditionNote conditionNote
     *
     * @return self
     */
    public function setConditionNote($conditionNote)
    {
        if (is_null($conditionNote)) {
            throw new \InvalidArgumentException('non-nullable conditionNote cannot be null');
        }
