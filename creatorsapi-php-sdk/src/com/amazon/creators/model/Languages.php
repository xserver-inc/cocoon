 ...
 *
 * @description Container for languages associated with the product.
...
class Languages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'displayValues' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\LanguageType[]',
        'label' => 'string',
        'locale' => 'string'
    ];
    ...
    {
        $this->setIfExists('displayValues', $data ?? [], null);
    ...
    */
     ...
     * Gets displayValues
     *
     * @return \Amazon\CreatorsAPI\v1\com\amazon\creators\model\LanguageType[]|null
     */
     ...
     * Sets displayValues
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\LanguageType[]|null $displayValues List of language types.
     *
     * @return self
     */
