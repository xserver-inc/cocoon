 ...
 *
 * @description Container for set of attributes that describes the technical aspects of the product.
 * @implements \ArrayAccess<string, mixed>
 */
class TechnicalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TechnicalInfo';
    ...
    protected static $openAPITypes = [
        'energyEfficiencyClass' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\SingleStringValuedAttribute',
        'formats' => '\Amazon\CreatorsAPI\v1\com\amazon\creators\model\MultiValuedAttribute'
    ];
    ...
    {
        $this->setIfExists('energyEfficiencyClass', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\SingleStringValuedAttribute|null $energyEfficiencyClass energyEfficiencyClass
     *
     * @return self
     */
     ...
     * Sets formats
     *
     * @param \Amazon\CreatorsAPI\v1\com\amazon\creators\model\MultiValuedAttribute|null $formats formats
     *
     * @return self
     */
