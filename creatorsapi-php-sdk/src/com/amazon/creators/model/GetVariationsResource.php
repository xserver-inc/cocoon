...
class GetVariationsResource
{
    ...
    public const VARIATION_SUMMARY_PRICE_HIGHEST_PRICE = 'variationSummary.price.highestPrice';

    public const VARIATION_SUMMARY_PRICE_LOWEST_PRICE = 'variationSummary.price.lowestPrice';

    public const VARIATION_SUMMARY_VARIATION_DIMENSION = 'variationSummary.variationDimension';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::VARIATION_SUMMARY_PRICE_HIGHEST_PRICE,
            self::VARIATION_SUMMARY_PRICE_LOWEST_PRICE,
            self::VARIATION_SUMMARY_VARIATION_DIMENSION
        ];
    }
}
