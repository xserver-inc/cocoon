 ...
 *
 * @description Container for contributor associated with the product.
 * @implements \ArrayAccess<string, mixed>
 */
class Contributor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets roleType
     *
     * @param string|null $roleType roleType
     *
     * @return self
     */
