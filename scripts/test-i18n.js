...
const COCOON_SETTINGS_NAVIGATION_MSGIDS = [
  ...
  '従来の表示',
  'これまでと同じ順番でタブを表示します。',
  '表示モードを保存できませんでした。この画面の表示は維持されますが、次回以降に引き継がれない可能性があります。通信状態を確認し、選択中の表示ボタンを押して再試行してください。',
  '表示モードの保存期限が切れました。この画面の表示は維持されますが、次回以降には引き継がれません。入力中の設定を確認してから、ページを再読み込みしてください。',
  '表示モードの保存がタイムアウトしました。この画面の表示は維持されますが、次回以降に引き継がれない可能性があります。通信状態を確認し、選択中の表示ボタンを押して再試行してください。',
  '表示モードを保存する権限がありません。この画面の表示は維持されますが、次回以降には引き継がれません。サイト管理者に権限を確認してください。',
  'Cocoon設定項目',
  '設定メニュー',
  '設定項目',
  '設定項目を検索',
