...
wp.domReady(function () {
    ...
    const addClasses = function () {
        ...
        // add body class
        jQuery('.is-root-container').wrapInner('<div>');
        jQuery('.is-root-container').children().addClass('cocoon-block-wrap body article' + gbSettings['siteIconFont'] + gbSettings['pageTypeClass']);
