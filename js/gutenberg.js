...
wp.domReady(function () {
    ...
    const addClasses = function () {
        ...
        jQuery('#editor .block-editor-writing-flow').parent().addClass('block-editor-cocoon-wrap body article page-body' + gbSettings['siteIconFont'] + gbSettings['pageTypeClass']);
