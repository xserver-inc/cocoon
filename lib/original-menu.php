...
function add_original_menu_in_admin_page() {
  ...
  //セパレーターの挿入
  add_admin_menu_separator(apply_filters('cocoon_add_theme_settings_page_separator', 57));
  //トップレベルメニューを追加する
  add_menu_page(SETTING_NAME_TOP, SETTING_NAME_TOP, 'manage_options', THEME_SETTINGS_PAFE, 'add_theme_settings_page', get_template_directory_uri().'/images/admin-menu-logo.png', apply_filters('cocoon_add_theme_settings_page', 58) );
