...
function add_original_menu_in_admin_page() {
  ...
  //トップレベルメニューを追加する
  add_menu_page(SETTING_NAME_TOP, __( 'Cocoon 設定', THEME_NAME ), 'manage_options', THEME_SETTINGS_PAFE, 'add_theme_settings_page', get_template_directory_uri().'/images/admin-menu-logo.png', apply_filters('cocoon_add_theme_settings_page_position', 29) );
