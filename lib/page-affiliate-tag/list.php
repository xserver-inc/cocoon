...
// レコード取得（ページネーション対応）
$records = get_affiliate_tags($keyword, $order_by, $limit, $offset);

// 総レコード数取得
$total = get_affiliate_tags_count($keyword);
// 総ページ数計算
...
<?php if ($records): ?>
  ...
  echo get_help_page_tag('https://wp-cocoon.com/how-to-use-affiliate-tag-manager/'); ?></p>
<?php else: ?>
