<table class="form-table">
  <tbody>
    <tr>
      ...
      <td>
        <input type="checkbox" name="<?php echo AD_ADS_VISIBLE_NAME; ?>" id="<?php echo AD_ADS_VISIBLE_NAME; ?>" value="1"<?php echo(is_ads_visible() ? ' checked="checked"' : ''); ?>><?php _e("全ての広告を表示する",THEME_NAME ); ?>
