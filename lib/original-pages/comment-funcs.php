...
function get_comment_heading(){
  return get_option(OP_COMMENT_HEADING, __( 'コメント', THEME_NAME ));
}
endif;
...
function get_comment_sub_heading(){
  return get_option(OP_COMMENT_SUB_HEADING);
}
endif;
...
function get_comment_form_heading(){
  return get_option(OP_COMMENT_FORM_HEADING, __( 'コメントをどうぞ', THEME_NAME ));
}
endif;
