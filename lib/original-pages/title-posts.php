...
update_theme_option(OP_INCLUDE_META_DESCRIPTION_TO_SINGULAR);
//投稿・固定ページにメタキーワードを含める
update_theme_option(OP_INCLUDE_KEYWORDS_TO_SINGULAR);
//カテゴリページのタイトル
update_theme_option(OP_CATEGORY_PAGE_TITLE_FORMAT);
//カテゴリページにメタディスクリプションを含める
update_theme_option(OP_INCLUDE_META_DESCRIPTION_TO_CATEGORY);
//カテゴリページにメタキーワードを含める
update_theme_option(OP_INCLUDE_KEYWORDS_TO_CATEGORY);
