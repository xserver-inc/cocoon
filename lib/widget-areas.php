...
// 投稿本文中にウィジェットを表示する
/////////////////////////////////////
add_filter('the_content','add_widget_area_before_1st_h2');
if ( !function_exists( 'add_widget_area_before_1st_h2' ) ):
function add_widget_area_before_1st_h2($the_content) {
  // if ( is_amp() ) {
  //   return $the_content;
  // }
