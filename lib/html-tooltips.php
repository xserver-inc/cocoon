...
function generate_select_color_tip_tag(){
  ob_start();?>
    <img src="https://im-cocoon.net/wp-content/uploads/ironodata.info_.png" alt="カラーサンプルサイト" loading="lazy" decoding="async" />
...
function generate_sidebar_top_ad_tip_tag(){
  ob_start();?>
    <img src="https://wp-cocoon.com/wp-content/uploads/2018/02/main-top-ad.png" alt="メインカラムトップの広告に注意" loading="lazy" decoding="async" />
...
function generate_main_column_top_ad_tip_tag(){
  ob_start();?>
    <img src="https://wp-cocoon.com/wp-content/uploads/2018/02/sidebar-ad.png" alt="サイドバートップの広告に注意" loading="lazy" decoding="async" />
    <p><?php _e( '広告にグローバルナビメニューが覆いかぶさっていませんか？', THEME_NAME ) ?><br>
    <?php _e( '広告設定の前にAdSenseポリシーをご確認ください。', THEME_NAME ) ?><br>
    <a href="https://support.google.com/adsense/answer/48182?hl=<?php _e( 'ja', THEME_NAME ) ?>" target="_blank" rel="noopener"><?php _e( 'AdSense プログラム ポリシー', THEME_NAME ) ?></a></p>
  <?php
