        ...
        <tr>
          ...
          <td>
            ...
            <ul>
              ...
              <li>
                <?php generate_checkbox_tag(OP_TOP_THREADS_SHARE_BUTTON_VISIBLE, is_top_threads_share_button_visible(), __( 'Threads', THEME_NAME )); ?>
              </li>
              <li>
                <?php generate_checkbox_tag(OP_TOP_REDDIT_SHARE_BUTTON_VISIBLE, is_top_reddit_share_button_visible(), __( 'Reddit', THEME_NAME )); ?>
              </li>
              <li>
