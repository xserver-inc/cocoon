      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <ul>
              <li>
                <?php generate_checkbox_tag(OP_TOP_BOTTOM_TWITTER_SHARE_BUTTON_VISIBLE, is_top_twitter_share_button_visible(), __( 'Twitter', THEME_NAME )); ?>
              </li>
              <li>
        ...
        <tr>
          ...
          <td>
            <?php
            generate_checkbox_tag( OP_SNS_TOP_SHARE_BUTTONS_COUNT_VISIBLE, is_sns_top_share_buttons_count_visible(), __( 'メインカラム本文上シェア数を表示', THEME_NAME ));
            generate_tips_tag(__( '投稿・固定ページのメインカラムにある本文上シェアボタンの表示を切り替えます。', THEME_NAME ));
            ?>
          </td>
        </tr>
