  ...
  <div class="inside">
    ...
    <?php if (DEBUG_ADMIN_DEMO_ENABLE && apply_filters('cocoon_setting_preview_all', true)): ?>
      ...
      <div class="demo iframe-standard-demo all-demo">
        <iframe id="all-demo" class="iframe-demo" src="<?php echo get_cocoon_settings_preview_url('all'); ?>" width="1000" height="400" loading="lazy"></iframe>
      </div>
    <?php endif; ?>
    ...
    <table class="form-table">
      <tbody>
            ...
            <div class="col-2">
              <div style="min-width: 270px;">
                ...
                if (is_wp_language_traditional_chinese()) {
                  $options['microsoft_jhenghei'] = __( 'Microsoft JhengHei', THEME_NAME ).__( '（繁體中文）', THEME_NAME );
                  $options['noto_sans_tc'] = __( 'Noto Sans TC', THEME_NAME ).__( '（繁體中文WEBフォント）', THEME_NAME );
                }
        ...
        <tr>
          ...
          <td>
            <?php
            generate_textbox_tag(OP_SITE_DATE_FORMAT, get_site_date_format(), __( SITE_DATE_FORMAT, THEME_NAME ));
