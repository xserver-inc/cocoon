      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            generate_tips_tag(__( 'ヘッダーのサイズを「ヘッダー背景画像」に設定した画像の縦横比サイズに合わせて表示させます。', THEME_NAME ).__( 'これにより背景画像が隠れることなく表示されます。', THEME_NAME ).__( '「ヘッダーレイアウト」設定が「センターロゴ」時のみ。', THEME_NAME ).__( 'ヘッダー設定にある「高さ」や「高さ（モバイル）」の値は無効になります。', THEME_NAME ));
            ?>
          </td>
        </tr>
