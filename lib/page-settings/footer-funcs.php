...
function get_site_initiation_year(){
  return get_theme_option(OP_SITE_INITIATION_YEAR, get_first_post_year() ? get_first_post_year() : wp_date('Y'));
}
endif;
...
function get_the_site_credit(){
  ...
  switch (get_credit_notation()) {
    ...
    case 'simple_year_begin_to_now':
      $credit = '© '.get_site_initiation_year().'-'.wp_date('Y').' '.get_copyright_display_name().'.';
      break;
    case 'full':
      $credit = 'Copyright © '.get_site_initiation_year().' '.get_copyright_display_name().' All Rights Reserved.';
      break;
    case 'full_year_begin_to_now':
      $credit = 'Copyright © '.get_site_initiation_year().'-'.wp_date('Y').' '.get_copyright_display_name().' All Rights Reserved.';
      break;
    default:
