      ...
      <tbody>
          ...
          <td>
            <div class="demo">
              ...
              $content = '<p><a href="https://im-cocoon.net/wp-content/uploads/cocoon.jpg" target="_blank" rel="noopener">
                  <img src="https://im-cocoon.net/wp-content/uploads/cocoon-267.jpg" alt="'.esc_attr__( 'デモ画像', THEME_NAME ).'">
                </a>&nbsp;
                <a href="https://im-cocoon.net/wp-content/uploads/tree.jpg" target="_blank" rel="noopener">
                  <img src="https://im-cocoon.net/wp-content/uploads/tree-300.jpg" alt="'.esc_attr__( 'デモ画像', THEME_NAME ).'">
                </a></p>
                ';
        ...
        <tr>
          ...
          <td>
            ...
            generate_tips_tag(__( '記事を保存したり公開したりするときに、本文中に最初に出てくる画像をアイキャッチにします。', THEME_NAME ) . __('パターン内にある画像は取得されません。', THEME_NAME).__( '※プレビューには反映されません。', THEME_NAME ));
            ?>
          </td>
        </tr>
