...
<div id="no-image-page" class="postbox">
  ...
  <div class="inside">
    ...
    <p><?php _e( 'サイト全体の画像やiframeをSEOに対応したLazy Load表示する設定です。', THEME_NAME ) ?></p>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            generate_tips_tag(__( 'Googleが推奨するメディアの遅延読み込み（Lazy Load）方法でページ表示を高速化します。対象メディアは、imgとiframeです。', THEME_NAME ));
