          ...
          <tbody>
            ...
            <tr <?php echo get_not_allowed_form_class(is_mobile_button_layout_type_mobile_buttons()); ?>>
              ...
              <td>
                ...
                generate_checkbox_tag(OP_MOBILE_HEADER_LOGO_VISIBLE , is_mobile_header_logo_visible(), __( 'ヘッダーロゴを表示する（モバイルヘッダーボタン表示時）', THEME_NAME ));
                generate_tips_tag(__( '「モバイルボタンレイアウト」で「ヘッダーモバイルボタン」が選択されているときヘッダーロゴを表示するか。', THEME_NAME ));
