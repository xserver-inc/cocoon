  ...
  <div class="inside">
    ...
    <?php if (DEBUG_ADMIN_DEMO_ENABLE && apply_filters('cocoon_setting_preview_404', true)): ?>
      ...
      <div class="demo iframe-standard-demo page-404-demo">
        ...
        ?>
        <iframe id="page-404-demo" class="iframe-demo" src="<?php echo get_cocoon_settings_preview_url('404'); ?>" width="1000" height="400" loading="lazy"></iframe>
      </div>
    <?php endif; ?>
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <?php
            // 入力済みと勘違いされないよう、プレースホルダー文字に「例：」を追加
            generate_textbox_tag(OP_404_PAGE_TITLE, get_404_page_title(), __('例：', THEME_NAME).T404_PAGE_TITLE);
        ...
        <tr>
          ...
          <td>
            <?php
            // 入力済みと勘違いされないよう、プレースホルダー文字に「例：」を追加
            generate_textarea_tag(OP_404_PAGE_MESSAGE, get_404_page_message(), __('例：', THEME_NAME).T404_PAGE_MESSAGE);
