      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            generate_tips_tag(__( 'フォローボタンの表示をまとめて切り替えます。', THEME_NAME ));
            ?>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <ul>
              <li>
                <?php generate_checkbox_tag(OP_SNS_FRONT_PAGE_FOLLOW_BUTTONS_VISIBLE, is_sns_front_page_follow_buttons_visible(), __( 'フロントページ', THEME_NAME ).__( '（インデックスページ）', THEME_NAME )); ?>
              </li>
              <li>
