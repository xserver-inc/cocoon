  ...
  <div class="inside">
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          <th scope="row">
            <?php genelate_label_tag(OP_COMMENT_HEADING, __('コメント一覧見出し', THEME_NAME) ); ?>
          </th>
          <td>
            <?php
        ...
        <tr>
          <th scope="row">
            <?php genelate_label_tag(OP_COMMENT_FORM_HEADING, __('コメント入力欄見出し', THEME_NAME) ); ?>
          </th>
          <td>
            <?php
            genelate_textbox_tag(OP_COMMENT_FORM_HEADING, get_comment_form_heading(), __( '見出し', THEME_NAME ));
            genelate_tips_tag(__( 'コメント入力欄の見出しを入力してください。', THEME_NAME ));
            ?>
          </td>
        </tr>
        ...
        <tr>
          <th scope="row">
            <?php genelate_label_tag(OP_COMMENT_WEBSITE_VISIBLE, __('ウェブサイトの表示', THEME_NAME) ); ?>
          </th>
          <td>
            <?php
