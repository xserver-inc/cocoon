      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <ul>
              <li>
                <?php generate_checkbox_tag(OP_BOTTOM_TWITTER_SHARE_BUTTON_VISIBLE, is_twitter_share_button_visible(), __( 'Twitter', THEME_NAME )); ?>
              </li>
              <li>
                <?php generate_checkbox_tag(OP_BOTTOM_FACEBOOK_SHARE_BUTTON_VISIBLE, is_facebook_share_button_visible(), __( 'Facebook', THEME_NAME )); ?>
              </li>
              <li>
                <?php generate_checkbox_tag(OP_HATEBU_SHARE_BUTTON_VISIBLE, is_hatebu_share_button_visible(), __( 'はてなブックマーク', THEME_NAME )); ?>
              </li>
              <li>
                <?php generate_checkbox_tag(OP_GOOGLE_PLUS_SHARE_BUTTON_VISIBLE, is_google_plus_share_button_visible(), __( 'Google', THEME_NAME )); ?>
              </li>
              <li>
                <?php generate_checkbox_tag(OP_POCKET_SHARE_BUTTON_VISIBLE, is_pocket_share_button_visible(), __( 'Pocket', THEME_NAME )); ?>
              </li>
              <li>
                <?php generate_checkbox_tag(OP_LINE_AT_SHARE_BUTTON_VISIBLE, is_line_at_share_button_visible(), __( 'LINE@', THEME_NAME )); ?>
              </li>
            </ul>
