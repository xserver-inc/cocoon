...
<div id="sns-share-bottom" class="postbox">
  <h2 class="hndle"><?php _e( 'ボトムシェアボタン設定', THEME_NAME ) ?></h2>
  <div class="inside">
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <?php
            generate_checkbox_tag( OP_SNS_BOTTOM_SHARE_BUTTONS_VISIBLE, is_sns_bottom_share_buttons_visible(), __( 'メインカラムボトムシェアボタンを表示する', THEME_NAME ));
        ...
        <tr>
          ...
          <td>
            ...
            <ul>
              <li>
                <?php generate_checkbox_tag(OP_SNS_FRONT_PAGE_BOTTOM_SHARE_BUTTONS_VISIBLE, is_sns_front_page_bottom_share_buttons_visible(), __( 'フロントページ', THEME_NAME ).__( '（インデックスページ）', THEME_NAME )); ?>
              </li>
              <li>
        ...
        <tr>
          ...
          <td>
            <?php
            generate_checkbox_tag( OP_SNS_BOTTOM_SHARE_BUTTONS_COUNT_VISIBLE, is_sns_bottom_share_buttons_count_visible(), __( 'シェア数を表示する', THEME_NAME ));
