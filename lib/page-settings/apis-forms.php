      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            generate_checkbox_tag(OP_AMAZON_ITEM_PRICE_VISIBLE , is_amazon_search_button_visible(), __( '価格を表示する', THEME_NAME ));
            get_amazon_item_price_visible(__( 'データー取得時点のAmazon販売ページでの値段を表示します。', THEME_NAME ));
