  ...
  <div class="inside">
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          <th scope="row">
            <?php generate_label_tag(OP_EXTERNAL_BLOGCARD_DOMAIN_STYLE, __( 'サイト情報', THEME_NAME ) ); ?>
          </th>
          <td>
            <?php
            $options = array(
            ...
            generate_radiobox_tag(OP_EXTERNAL_BLOGCARD_DOMAIN_STYLE, $options, get_external_blogcard_domain_style());
