...
//HTTPSリダイレクト用
define('THEME_HTACCESS_HTTPS_REDIRECT_BEGIN', '#BEGIN '.THEME_NAME_UPPER.' HTACCESS HTTPS REDIRECT');
define('THEME_HTACCESS_HTTPS_REDIRECT_END',   '#END '  .THEME_NAME_UPPER.' HTACCESS HTTPS REDIRECT');
define('THEME_HTACCESS_HTTPS_REDIRECT_REG', '{'.THEME_HTACCESS_HTTPS_REDIRECT_BEGIN.'.+?'.THEME_HTACCESS_HTTPS_REDIRECT_END.'}s')
