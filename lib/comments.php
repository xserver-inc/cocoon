    ...
    <div id="div-comment-<?php comment_ID(); ?>" class="st-comment-body article">
      ...
      <div class="st-comment-meta st-commentmetadata">
        <span class="st-comment-author vcard">
          ...
          <?php printf(__('<span class="comment-author-label">名前:</span><cite class="fn comment-author">%s<span class="admin"></span></a></cite><span class="comment-author-separator"> :</span>', THEME_NAME), get_comment_author_link()); //投稿者の設定 ?>
        </span>
