...
(function () {
  ...
  (function () {
    ...
    function updateSummary(filtered) {
      ...
      summaryEl.textContent = (i18n.shown_period_total || '') + ': ' + shownTotal.toLocaleString() + ' PV' +
        ' (' + (i18n.list_period_total || '') + ': ' + listTotal.toLocaleString() + ' PV / ' +
        (i18n.all_total || '') + ': ' + allTotal.toLocaleString() + ' PV)';
