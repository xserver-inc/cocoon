    ...
    <div class="cocoon-analytics-lifecycle-container" data-initial-post-id="<?php echo esc_attr($post_id); ?>">
      ...
      <div class="lifecycle-content">
        ...
        <div id="lifecycle-period-selector" class="lifecycle-period-selector" style="<?php echo $post_id > 0 ? '' : 'display:none;'; ?>">
          <button type="button" class="lifecycle-period-btn button" data-period="7"><?php _e('直近7日', THEME_NAME); ?></button>
          <button type="button" class="lifecycle-period-btn button is-active" data-period="30"><?php _e('直近30日', THEME_NAME); ?></button>
          <button type="button" class="lifecycle-period-btn button" data-period="90"><?php _e('直近90日', THEME_NAME); ?></button>
          <button type="button" class="lifecycle-period-btn button" data-period="365"><?php _e('直近1年', THEME_NAME); ?></button>
