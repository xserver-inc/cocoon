...
class DistributionFilesTest extends TestCase
{
    ...
    public function test_Git配布アーカイブに設定画面の実行ファイルだけが含まれる(): void
    {
        ...
        try {
            ...
            $this->assertNotContains(
                'docs/COCOON-SETTINGS-DESIGN-IMPLEMENTATION-PLAN.md',
                $archiveEntries
            );
            $this->assertNotContains(
                'docs/COCOON-SETTINGS-DATA-COMPATIBILITY-REPORT.md',
                $archiveEntries
            );
    ...
    public static function devOnlyPathsProvider(): array
    {
        return [
            ...
            'Cocoon設定実装計画書' => ['/docs/COCOON-SETTINGS-DESIGN-IMPLEMENTATION-PLAN.md', '内部実装計画書'],
