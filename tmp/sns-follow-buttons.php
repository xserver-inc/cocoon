...
<div class="sns-follow<?php echo get_additional_sns_follow_button_classes(); ?>">
  ...
  <?php if ( is_feedly_follow_button_visible() )://feedlyフォローボタンを表示するか ?>
    <a href="//feedly.com/i/subscription/feed/<?php bloginfo("rss2_url"); ?>" class="follow-button feedly-button feedly-follow-button-sq" target="blank" title="<?php _e( 'feedlyで更新情報を購読', THEME_NAME ) ?>" rel="nofollow"><span class="icon-feedly-logo"></span><span class="follow-count feedly-follow-count">0</span></a>
  <?php endif; ?>
