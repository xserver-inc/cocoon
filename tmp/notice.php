...
<div id="notice-area-wrap" class="notice-area-wrap">
  ...
  ?>
    <a href="<?php echo esc_url($url); ?>" id="notice-area-link" class="notice-area-link"<?php echo $target; ?>>
  <?php endif; ?>

  <div id="notice-area" class="notice-area nt-<?php echo esc_attr(get_notice_type()); ?>">
