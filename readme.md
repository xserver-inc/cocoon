...
いらすとやさんの素材については、CDN配信という条件の下、利用料をお支払いする形で特別な許可を得て使用させていただいています。Cocoonテーマを改造して配布したテーマでの利用はできませんのでご了承ください。
尚、吹き出し管理画面で「(c)いらすとや」となっているアイコン素材の著作権はすべて作者のみふねたかし氏に帰属します。GPLライセンスではありません。
