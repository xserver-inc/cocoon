...
if (
  ...
  $skin_gnavi_nooutput = (($skin_gnavi_snsbtn_options['gnavi_sns_twitter'] === 'snsbtn_select_On') && get_the_author_twitter_url($user_id)) ||
    ...
    (isset($skin_gnavi_snsbtn_options['gnavi_sns_threads']) && ($skin_gnavi_snsbtn_options['gnavi_sns_threads'] === 'snsbtn_select_On') && get_the_author_threads_url($user_id)) ||
...
?>
    ...
    <li class="header-snsicon-submenu">
      <ul class="header-snsicon-submenu__list sub-menu">
        ...
        <?php if (isset($skin_gnavi_snsbtn_options['gnavi_sns_threads']) && ($skin_gnavi_snsbtn_options['gnavi_sns_threads'] === 'snsbtn_select_On') && get_the_author_threads_url($user_id)) : //Threadsフォローボタンを表示するか
        ?>
          <li class="header-snsicon-submenu__listitem">
            <a href="<?php echo esc_url(get_the_author_threads_url($user_id)); //ThreadsフォローURLの取得
