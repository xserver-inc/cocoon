...
if (!function_exists('enqueue_skin_grayish_google_fonts')) :
  ...
  {
    wp_enqueue_style('skin_grayish-google-fonts', 'https://fonts.googleapis.com/css2?family=Roboto+Slab:200,400|Spectral:200,400|Inknut+Antiqua:300,400|Jost:300,400|Lato:300,400|Lora|Montserrat:200,400&display=swap');
  }
endif;
