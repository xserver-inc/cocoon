...
function org_theme_add_editor_styles() {
    $editor_style_url = get_theme_file_uri( '/skins/skin-tegakinote-blue-coral/editor-style.css' );
...
function css_custom() {
	$content_color = get_site_background_color() ?: '#f0ebe8';
	echo '
	.container,
...
function bg_image_css() {
	...
	if (get_theme_mod('bg_image_control') === 'bg_grid') {
		$style_image = 'linear-gradient(180deg, rgba(var(--white-color-rgb),0) 93%, var(--white-color) 100%),linear-gradient(90deg, rgba(var(--white-color-rgb),0) 93%, var(--white-color) 100%)';
		$style_size= '15px 15px';
	} elseif (get_theme_mod('bg_image_control') === 'bg_grid_paper') {
		$style_image = 'linear-gradient(rgba(var(--white-color-rgb),.7) 1%, rgba(var(--white-color-rgb),.7) 1%, transparent 1%,   transparent 99%, rgba(var(--white-color-rgb),.7) 99%, rgba(var(--white-color-rgb),.7) 100%),  linear-gradient(90deg, rgba(var(--white-color-rgb),.7) 1%, rgba(var(--white-color-rgb),.7) 1%, transparent 1%,   transparent 99%, rgba(var(--white-color-rgb),.7) 99%, rgba(var(--white-color-rgb),.7) 100%),  linear-gradient(transparent, transparent 25%, rgba(var(--white-color-rgb),.4) 25%, rgba(var(--white-color-rgb),.4) 26%, transparent 26%,   transparent 50%, rgba(var(--white-color-rgb),.4) 50%, rgba(var(--white-color-rgb),.4) 51%, transparent 51%,   transparent 75%, rgba(var(--white-color-rgb),.4) 75%, rgba(var(--white-color-rgb),.4) 76%, transparent 76%, transparent 100%),  linear-gradient(90deg, transparent, transparent 25%, rgba(var(--white-color-rgb),.4) 25%, rgba(var(--white-color-rgb),.4) 26%, transparent 26%,   transparent 50%, rgba(var(--white-color-rgb),.4) 50%, rgba(var(--white-color-rgb),.4) 51%, transparent 51%,   transparent 75%, rgba(var(--white-color-rgb),.4) 75%, rgba(var(--white-color-rgb),.4) 76%, transparent 76%, transparent 100%)';
		$style_size = '80px 80px';
	} elseif (get_theme_mod('bg_image_control') === 'bg_line') {
		$style_image = 'linear-gradient(var(--white-color) .1px, rgba(var(--white-color-rgb),0) .05em)';
		$style_size = 'auto 1em';
	} elseif (get_theme_mod('bg_image_control') === 'bg_dot') {
		$style_image = 'radial-gradient(var(--white-color) 3px, rgba(var(--white-color-rgb),0) 3px)';
