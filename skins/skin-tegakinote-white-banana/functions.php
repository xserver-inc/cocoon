...
function skin_global_nav_settings($wp_customize) {
	...
	$wp_customize->add_control(
		...
		array(
			...
			'description' => 'チェックを入れると、グローバルナビの色（背景色・文字色）を設定した際に、スマホのカード型メニューを通常表示に切り替えます（文字が見えなくなるのを防ぎます）。カード型を維持したい場合はチェックを外してください。※ この設定はカスタマイザーのプレビューにはリアルタイムで反映されません。「公開」ボタンを押した後、実際のスマートフォンでご確認ください。',
