...
function bg_image_css() {
	...
	if (get_theme_mod('bg_image_control') === 'bg_grid') {
		$style_image = 'linear-gradient(180deg, rgba(var(--gray-color),0) 93%, rgba(var(--gray-color), 1) 100%),linear-gradient(90deg, rgba(var(--gray-color),0) 93%, rgba(var(--gray-color), 1) 100%)';
		$style_size= '15px 15px';
	} elseif (get_theme_mod('bg_image_control') === 'bg_grid_paper') {
		$style_image = 'linear-gradient(rgba(var(--gray-color),.7) 1%, rgba(var(--gray-color),.7) 1%, transparent 1%,   transparent 99%, rgba(var(--gray-color),.7) 99%, rgba(var(--gray-color),.7) 100%),  linear-gradient(90deg, rgba(var(--gray-color),.7) 1%, rgba(var(--gray-color),.7) 1%, transparent 1%,   transparent 99%, rgba(var(--gray-color),.7) 99%, rgba(var(--gray-color),.7) 100%),  linear-gradient(transparent, transparent 25%, rgba(var(--gray-color),.4) 25%, rgba(var(--gray-color),.4) 26%, transparent 26%,   transparent 50%, rgba(var(--gray-color),.4) 50%, rgba(var(--gray-color),.4) 51%, transparent 51%,   transparent 75%, rgba(var(--gray-color),.4) 75%, rgba(var(--gray-color),.4) 76%, transparent 76%, transparent 100%),  linear-gradient(90deg, transparent, transparent 25%, rgba(var(--gray-color),.4) 25%, rgba(var(--gray-color),.4) 26%, transparent 26%,   transparent 50%, rgba(var(--gray-color),.4) 50%, rgba(var(--gray-color),.4) 51%, transparent 51%,   transparent 75%, rgba(var(--gray-color),.4) 75%, rgba(var(--gray-color),.4) 76%, transparent 76%, transparent 100%)';
		$style_size = '80px 80px';
	} elseif (get_theme_mod('bg_image_control') === 'bg_line') {
		$style_image = 'linear-gradient(rgba(var(--gray-color), 1) .1px, rgba(var(--gray-color),0) .05em)';
		$style_size = 'auto 1em';
	} elseif (get_theme_mod('bg_image_control') === 'bg_dot') {
		$style_image = 'radial-gradient(rgba(var(--gray-color), 1) 3px, rgba(var(--gray-color),0) 3px)';
