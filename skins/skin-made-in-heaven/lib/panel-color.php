...
//  基本カラー
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('基本カラー', THEME_NAME));
...
//  個別カラー
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('個別カラー', THEME_NAME));
...
//  グローバルナビメニューデザイン
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('グローバルナビメニューデザイン', THEME_NAME));
...
//  見出しデザイン
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('見出しデザイン', THEME_NAME));
