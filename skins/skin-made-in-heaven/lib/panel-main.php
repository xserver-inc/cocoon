...
//  ローディン画面
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('ローディン画面', THEME_NAME));
...
//  全体
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('全体', THEME_NAME));
...
//  目次
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('目次', THEME_NAME));
  ...
  hvn_panel_control($wp_customize, $section, 'hvn_toc_top_setting'    , ['default' => false], __('先頭に表示', THEME_NAME), '', [], 'checkbox');
...
//  プロフィール
//******************************************************************************
  hvn_panel_label($wp_customize, $section, __('プロフィール', THEME_NAME));

  hvn_panel_control($wp_customize, $section, 'hvn_prof_video_setting'      , [], '', __('背景動画', THEME_NAME), [], 'video');
  ...
  hvn_panel_control($wp_customize, $section, 'hvn_profile_follows_color_setting' , ['default' => false ], __('SNSフォローカラー表示', THEME_NAME), '', [], 'checkbox');
}
endif;
