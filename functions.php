  ...
  <table class="form-table">
    <tr>
      ...
      <?php
       ...
       ?>
       <p class="description"><?php _e( '自前でプロフィール画像をアップロードする場合は画像を選択してください。Gravatarよりこちらのプロフィール画像が優先されます。300×300以上の正方形の画像がお勧めです。', THEME_NAME ) ?><br>
        <?php _e( 'ページサイズ縮小のため<a href="https://tinypng.com/" target="_blank">TinyPNG</a>登録前にで圧縮することをおすすめします。', THEME_NAME ) ?></p>
      </td>
    </tr>
  </table>
<?php
