  ...
  const classes = classnames(
    {
      ...
      [ `sbs-${ speechBalloons[index].style  }` ]: !! speechBalloons[index].style ,
      [ `sbp-${ speechBalloons[index].position  }` ]: !! speechBalloons[index].position ,
      [ `sbis-${ speechBalloons[index].iconstyle  }` ]: !! speechBalloons[index].iconstyle ,
      [ 'cf' ]: true,
      [ 'block-box' ]: true,
    }
  );
