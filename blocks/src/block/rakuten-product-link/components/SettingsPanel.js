    ...
    <InspectorControls>
      ...
      <PanelBody title={ __( '表示設定', THEME_NAME ) } initialOpen={ true }>
        ...
        <SelectControl
          ...
          value={ size }
          options={ [
            { label: __( '小（64px）', THEME_NAME ), value: 's' },
            { label: __( '中（128px）', THEME_NAME ), value: 'm' },
          ] }
      ...
      >
        <SelectControl
          ...
          options={ [
            { label: __( '通常購入', THEME_NAME ), value: '0' },
      ...
      >
        ...
        ! Number( window.gbRakutenBlockDefaults.hasMoshimoIds ) ? (
          <p
            style={ {
              fontSize: '12px',
              color: '#999',
