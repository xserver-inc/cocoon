...
export default function edit( props ) {
  ...
  function addTab() {
    ...
    tabLabels = tabLabelsArray.concat(
      __( 'Tab', THEME_NAME ) + ' ' + ( tabLabelsArray.length + 1 )
    );
  ...
  function changeTabLabel( index, value ) {
    const tabLabels = tabLabelsArray.concat();
  ...
  function moveTabUp( index ) {
    let tabLabels = tabLabelsArray.concat();
            ...
            return (
              <div className={ 'tab-setting tab-setting-' + index }>
                <TextControl
                  ...
                  value={ label }
                  onChange={ ( value ) => changeTabLabel( index, value ) }
                />
                <Button
                  disabled={ tabLabelsArray.length > 1 ? false : true }
                  onClick={ () => {
                    deleteTab( index );
                  } }
                >
                ...
                <Button
                  disabled={
                    index + 1 === tabLabelsArray.length ? true : false
                  }
                  onClick={ () => {
                    moveTabDown( index );
                  } }
